...
export const ORDER_STATUS_CONFIG: Record<string, { label: string; color: string; bg: string; icon: any }> = {
  ...
  SHIPPED_TO_WAREHOUSE: { label: 'Shipped to Hub', color: 'text-indigo-600', bg: 'bg-indigo-100 dark:bg-indigo-900/30', icon: Truck },
  RECEIVED_AT_WAREHOUSE: { label: 'Received at Hub', color: 'text-indigo-600', bg: 'bg-indigo-100 dark:bg-indigo-900/30', icon: Package },
  ASSIGNED_TRANSPORT: { label: 'Assigned Transport', color: 'text-indigo-600', bg: 'bg-indigo-100 dark:bg-indigo-900/30', icon: Truck },
  IN_TRANSIT: { label: 'In Transit', color: 'text-indigo-600', bg: 'bg-indigo-100 dark:bg-indigo-900/30', icon: Truck },
